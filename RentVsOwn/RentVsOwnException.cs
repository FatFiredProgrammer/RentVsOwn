...
namespace RentVsOwn
{
    ...
    [PublicAPI]
    [Serializable]
    public sealed class RentVsOwnException : Exception
    {
        /// <summary>Constructor</summary>
        public RentVsOwnException()
        {
        }

        /// <summary>Constructor</summary>
        /// <param name="message">String setting the message of the exception.</param>
        public RentVsOwnException(string message)
            : base(message)
        {
        }
        ...
        public RentVsOwnException(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        private RentVsOwnException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
